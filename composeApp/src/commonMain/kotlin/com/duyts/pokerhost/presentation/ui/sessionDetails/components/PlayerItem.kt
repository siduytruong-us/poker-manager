...
import pokerhost.composeapp.generated.resources.player_stats_format
import pokerhost.composeapp.generated.resources.profit_format
		...
		Column(modifier = Modifier.padding(16.dp)) {
			Row(
				...
				Row(verticalAlignment = Alignment.CenterVertically) {
					Text(
						text = stringResource(
							Res.string.profit_format,
							CurrencyUtils.format(player.netProfit)
						),
