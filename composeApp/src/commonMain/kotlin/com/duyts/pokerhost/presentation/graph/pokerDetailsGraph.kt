...
import com.duyts.pokerhost.presentation.ui.sessionDetails.PokerSessionDetailScreen
	...
	navigation<Route.PokerSessionGraph>(
		...
		composable<Route.PokerSessionDetail>(
			...
			PokerSessionDetailScreen(
				...
				onUpdatePlayerArchiveStatus = { id, archived ->
					viewModel.updatePlayerArchiveStatus(
						id,
						archived
					)
				},
